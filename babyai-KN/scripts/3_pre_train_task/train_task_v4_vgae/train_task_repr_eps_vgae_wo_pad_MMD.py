...
parser.add_argument("--MMD", type=str, default='MMD_')
...
args.log_time = cur_time.strftime("[%m-%d]%H.%M.%S")+ '_bs_' + str(args.batch_size_) + '_wo_pad' + 'BCE_' + str(args.BCE_weight) + 'KL_' + str(args.KL_weight) \
