...
args.save_logdir = '/data2/username_high/username/BABYAI/babyai-dyth-v1.1-and-baselines-CORRO/scripts/3_pre_train_task/train_task_v6_corro/logs_models_v6_4_tasks_new/'

args.loader_path = '/data2/username_high/username/BABYAI/data_new/best_data_new/datasets_npy/data_4_task_new.npy'
...
if __name__ == '__main__':
    ...
    args.hidden_size_lst = [256, 256, 128, 64, 32]
    args.lambda_push = 0.3
    ...
    for epoch in tqdm(range(args.n_epoch)): # self.training_mode(True)
        ...
        queries, keys, negs, task_num = sample_pairs_than_others(npy_loader, args.contrastive_batch_size, args.sizes) # 64
        ...
        if task_num == npy_loader.shape[0] - 1: # last task
            contrastive_loss_ = args.lambda_push * contrastive_loss_
