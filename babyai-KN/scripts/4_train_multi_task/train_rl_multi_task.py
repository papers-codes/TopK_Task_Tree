...
from babyai.model_vgae import ACModel
...
args.hidden2_dim = 64
args.use_vgae = True
args.use_vgae_str = 'vgae'
args.val_episodes = 128
args.no_instr = True
args.instr_arch = 'None'
args.no_mem = True
...
model_name_parts = {
    ...
    'coef': '',
    'suffix': suffix}
default_model_name = "{env}_{algo}_{vgae}_{arch}_{instr}_{mem}_seed{seed}{info}{coef}_{suffix}".format(**model_name_parts)
...
if acmodel is None:
    if args.pretrained_model:
        ...
        acmodel = ACModel(args, obss_preprocessor.obs_space, envs[0].action_space, # {'image': 147, 'instr': 100}  # Discrete(7)
                          args.image_dim, args.memory_dim, args.instr_dim, args.hidden2_dim,  # 128 128 128
                          not args.no_instr, args.instr_arch, not args.no_mem, args.arch)  # True, 'gru', True, 'bow_endpool_res'

obss_preprocessor.vocab.save()
# utils.save_model(acmodel.state_dict(), args.model)
...
if args.algo == "ppo":
    algo = babyai.rl.PPOAlgo_VGAE(args, envs, acmodel, args.frames_per_proc, args.discount, args.lr, args.beta1, args.beta2,
                             args.gae_lambda,
...
while status['num_frames'] < args.frames:
    print(status['num_frames'], args.frames)
    # Update parameters
    ...
    if args.save_interval > 0 and status['i'] % args.save_interval == 0:
        ...
        if success_rate > best_success_rate:
            ...
            save_model = True
        if save_model:
            # utils.save_model(acmodel.state_dict(), args.model + '_best')
