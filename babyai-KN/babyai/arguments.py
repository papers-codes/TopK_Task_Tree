...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        self.add_argument("--K", type=int, default=1,
                            help="width")
        self.add_argument("--N", type=int, default=1,
                            help="depth")
        self.add_argument("--sim_threshold", type=float, default=0.5, help="similarity score threshold")
        self.add_argument("--seedlist", type=int, nargs='+', default=[0, 1], help="seed list")
        ...
        self.add_argument("--frames", type=int, default=int(10e6),
                            help="number of frames of training (default: 9e10)")
        ...
        self.add_argument("--no-instr", action="store_true", default=True,
                            help="don't use instructions in the model")
        ...
        self.add_argument("--arch", default='endpool_res',
                            help="image embedding architecture")
