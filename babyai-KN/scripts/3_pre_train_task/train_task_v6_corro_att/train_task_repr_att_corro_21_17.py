...
args.save_logdir = '/data2/username_high/username/BABYAI/babyai-dyth-v1.1-and-baselines-CORRO/scripts/3_pre_train_task/train_task_v6_corro_att/logs_models_v6_att_4_tasks_new/'
...
if __name__ == '__main__':
    ...
    encoder = MLPEncoder(
        ...
        normalize=args.normalize_ # True
        ).to(ptu.device)
