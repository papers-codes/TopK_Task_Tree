...
#### 区分 log
# path_root_ = './logs_models/' + '[06-06]23.32.32KL_mul_1.0'
# path_root_ = './logs_models/' + '[06-06]23.35.10KL_mul_0.1'
path_root_ = './logs_models/' + '[06-06]23.37.16KL_mul_0.1_contra_loss'
path_root_models_ = path_root_ + '/models/vae_epoch_15.pt'
