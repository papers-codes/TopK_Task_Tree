...
args.save_logdir = '/data2/username_high/username/BABYAI/babyai-dyth-v1.1-and-baselines-CORRO/scripts/3_pre_train_task/train_task_v8_corro_recon/logs_models_v8_4_tasks_new/'
...
if __name__ == '__main__':
    ...
    for epoch in tqdm(range(args.n_epoch)): # self.training_mode(True)
        ...
        #### reconstructive loss
        pred_obss_q = decoder(q_z)
        pred_obss_k = decoder(k_z)
        pred_obss_neg = decoder(neg_z)
