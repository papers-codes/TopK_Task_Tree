...
storage_dir = root_ + 'babyai-dyth-v1.1-and-baselines/scripts/pre_train_task/datasets_episode/'
...
if __name__ == "__main__":
    ...
    args.model = root_ + 'models/BabyAI-OpenDoorColor-v0_ppo_bow_endpool_res_gru_mem_seed1_22-06-04-16-56-41_best'
    args.env = 'BabyAI-OpenDoorColor-v0'
    ...
    data_dir = os.path.join(storage_dir, "best_data", data_name)
