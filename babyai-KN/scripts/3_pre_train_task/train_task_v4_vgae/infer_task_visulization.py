...
#### 区分 log
loader_path = '/data2/username_high/username/BABYAI/babyai-dyth-v1.1-and-baselines/scripts/pre_train_task/datasets_episode/train_loader_4_eps_bs64_wo_pad'
save_logdir = '/data2/username_high/username/BABYAI/babyai-dyth-v1.1-and-baselines/scripts/pre_train_task/train_task_v4_vgae/logs_models_v4/'

path_root_ = save_logdir + '[06-13]10.51.30_bs_64_wo_padBCE_5.0KL_0.01contra_loss_1000.0MMD_10.0'
...
path_root_pdf_ = path_root_ + '/data_z_labels_2d_mean_pooling.pdf'
...
args.actual_max_eps_len = 46 ### !!!!!!!! modify here
