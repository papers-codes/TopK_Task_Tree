...
if __name__ == '__main__':
    ...
    args.obs_loss_coef, args.rew_loss_coef, args.kl_loss_coef, args.cons_loss_coef = 1.0, 1.0, 0.3, 0.5
    
    vae = VAE(args.task_embedding_size, args.obs_dim, args.n_actions, args.rew_dim, args.n_agents, args.hiddens, args.activation)
