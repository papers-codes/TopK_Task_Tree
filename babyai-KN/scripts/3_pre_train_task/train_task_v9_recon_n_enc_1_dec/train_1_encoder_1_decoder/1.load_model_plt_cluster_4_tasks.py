...
args.save_logdir = '/data2/username_high/username/BABYAI/babyai-dyth-v1.1-and-baselines-CORRO/scripts/3_pre_train_task/train_task_v9_recon_n_enc_1_dec/train_1_encoder_1_decoder/logs_models_v9_4_tasks_new'
...
def vis_sample_embeddings_2(random_flag, npy_loader, save_path):
    ...
    save_path_cur = os.path.join(save_path, "test_fig_"+ "Set2_4400000" +".png")
    import brewer2mpl
...
if __name__ == '__main__':
    ...
    args.log_time = '[10-06]21.54.33train_loader_bs_64_corro_others_neg_/'
    args.model_path = '/data2/username_high/username/BABYAI/babyai-dyth-v1.1-and-baselines-CORRO/scripts/3_pre_train_task/train_task_v9_recon_n_enc_1_dec/train_1_encoder_1_decoder/logs_models_v9_4_tasks_new/[10-06]21.54.33train_loader_bs_64_corro_others_neg_/models/encoder_epoch_4400000.pt'
    ...
    save_path_ = '/data2/username_high/username/BABYAI/babyai-dyth-v1.1-and-baselines-CORRO/scripts/3_pre_train_task/train_task_v9_recon_n_enc_1_dec/train_1_encoder_1_decoder/logs_models_v9_4_tasks_new/[10-06]21.54.33train_loader_bs_64_corro_others_neg_/vis_z_plt/'
