...
from babyai.rl.algos.base_ours import BaseAlgo_Ours


class PPOAlgo_Ours(BaseAlgo_Ours):
    """The class for the Proximal Policy Optimization algorithm
    ([Schulman et al., 2015](https://arxiv.org/abs/1707.06347))."""

    def __init__(self, envs, acmodel, encoder_tuple, args, num_frames_per_proc=None, discount=0.99, lr=7e-4, beta1=0.9, beta2=0.999,
                 gae_lambda=0.95,
        ...
        super().__init__(envs, acmodel, encoder_tuple, args, num_frames_per_proc, discount, lr, gae_lambda, entropy_coef,
            ...
            for _ in range(self.epochs):
                ...
                for inds in self._get_batches_starting_indexes():
                    ...
                    for i in range(self.recurrence-1):
                        ...
                        pred_obs = self.query_encoder.pred(torch.cat((query_emb, sb.task_embs.detach()), dim=-1))  # 2.147
                        # MSE loss
