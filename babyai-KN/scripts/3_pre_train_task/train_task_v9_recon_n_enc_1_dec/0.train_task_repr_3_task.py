...
args.save_logdir = '/data2/username_high/username/BABYAI/babyai-dyth-v1.1-and-baselines-CORRO/scripts/3_pre_train_task/train_task_v9_recon_n_enc_1_dec/logs_models_v9_3_tasks_new/'
...
if __name__ == '__main__':
    ...
    for epoch in tqdm(range(args.n_epoch)): # self.training_mode(True)
        ...
        q_z = m_encoder_1_decoder_.encoders[int(label_q[0]-1)].forward(obs_q, actions_q, rewards_q, next_obs_q) # 64,5
        k_z = m_encoder_1_decoder_.encoders[int(label_k[0]-1)].forward(obs_k, actions_k, rewards_k, next_obs_k) # 64.5 
        
        #########  method 1 begins #### qicker than method 2 about 0.1s every 100 times
        # start_time = time.time()  #
        neg_z_ = torch.stack([m_encoder_1_decoder_.encoders[int(i-1)].forward(obs_neg.reshape(b_dot_N, -1), actions_neg.reshape(b_dot_N, -1), \
