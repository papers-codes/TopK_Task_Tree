...
args.arch = 'endpool_res'
#### load subtask enocoder models
args.model_path = 'babyai-KN/scripts/3_pre_train_task/train_task_v9_recon_n_enc_1_dec/model_pretrain/encoder_epoch_740000.pt'
args.random_walk = False ## pathfinding method 1
args.dis_max_path = True ## pathfinding method 2
args.subtask_count = [1, 1, 1, 1]    ### for discounted path palnning :: selection count
args.subtask_mean_rew = [0, 0, 0, 0] ### for discounted path palnning :: selection mean rew
...
default_model_name = "{env}_{algo}_Ours_newest_K_{K}_N_{N}_{arch}_{instr}_{mem}_seed{seed}{info}{coef}_{suffix}".format(**model_name_parts)
