...
# from babyai.models.vgae import VGAE
from babyai.models.vgae_para import VGAE_batch as VGAE
...
class ACModel(nn.Module, babyai.rl.RecurrentACModel):
    def __init__(self, args, obs_space, action_space,
                 image_dim=128, memory_dim=128, instr_dim=128, vgae_hidden2_dim=64,
        ...
        self.args = args
        self.use_vgae = self.args.use_vgae
        ...
        self.vgae_hidden2_dim = vgae_hidden2_dim
        ...
        if self.use_vgae:
            ...
            self.embedding_size += self.vgae_hidden2_dim
    ...
    def forward(self, obs, z_tensor, memory, instr_embedding=None):
        # import pdb
        # pdb.set_trace()
        ...
        if self.use_instr:
            for controller in self.controllers:
                ...
                if self.res:
                    out += x
                x = out
        x = F.relu(self.film_pool(x)) # 1.128.7.7 -->
        ...
        embedding = torch.cat((embedding, z_tensor), dim=1)
